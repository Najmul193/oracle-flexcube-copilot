...
def test_bm25_indexer_retriever(tmp_path: Path):
    ...
    chunk1 = Chunk(id="c1", document_id="d1", text="Oracle FLEXCUBE STTM_PRODUCT module", metadata=meta)
    chunk2 = Chunk(id="c2", document_id="d1", text="Retail Lending and CASA integration", metadata=meta)
    chunk3 = Chunk(id="c3", document_id="d1", text="Some unrelated text without keywords", metadata=meta)
