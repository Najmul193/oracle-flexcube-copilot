...
class TestChromaIndexer:
    ...
    def test_duplicate_prevention(self, temp_db_dir: Path, dummy_chunks: list[EmbeddedChunk]) -> None:
    ...
    def test_persistence_across_instances(self, temp_db_dir: Path, dummy_chunks: list[EmbeddedChunk]) -> None:
