...
class Chunk(BaseModel):
    ...
    # Enrichment
    oracle_entities: list[OracleEntity] = Field(default_factory=list, description="Entities found in this chunk")
    references: list[Reference] = Field(default_factory=list, description="Cross-references in this chunk")
    table_ids: list[str] = Field(default_factory=list, description="IDs of tables referenced/included")
